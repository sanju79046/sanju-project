  ...
  return (
    <div  className="HomePage">
      <div >
        ...
        <h1 className="front">How Can freelancers<br></br>
        Hello your Buisness?</h1>
        <p className="front-down">
          The Possibilities are endless.We have expert</p>
         <p className="front-down"> freelancers who work in every technical,professional,</p>
         <p className="front-down">and creative field imaginable</p>
      
      </div>
      <div>
        <button className='find-freelance-button'>Find Freelance</button>
      </div>
...
Only pay for work when it has been completed and you're 100% satisfied with the quality using our milestone payment system.
      ...
      <div className='paragraph'>
        <p>
        <h3 style={{ textDecoration: 'underline',}}className='topic'>What's great about it?</h3>
        </p>
      </div>
      ...
      <div className='paragraph'>
        ...
        Freelancer.com has by far the largest pool of quality freelancers globally- over 70 million to choose from        </p>
      </div>
